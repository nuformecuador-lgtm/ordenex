...
// ---------------------------------------------------------------------------
// Feature 311 — C2.T / F2.T (R1/R7/R12/R14/R23). Columnas nuevas y autorizacion del proxy.
// ---------------------------------------------------------------------------
...
describe("Feature 311 · ChatMensajeRepository — columnas nuevas (R1/R7)", () => {
...
describe("Feature 311 · findMediaParaMensajero — autorizacion del proxy (R23)", () => {
