...
describe("ORDER_STATUS_SEED (R1/R5/R12 · 135 rename · 139 devolucion · 154 v2 · 155 retiro)", () => {
  it("contiene exactamente los 19 valores esperados", () => {
  ...
  it("feature 154/R1/R2: por_recolectar_en_tienda e incidente cierran el catalogo", () => {
    expect(ORDER_STATUS_SEED[17]).toBe("por_recolectar_en_tienda");
    expect(ORDER_STATUS_SEED[18]).toBe("incidente");
    expect(ORDER_STATUS_SEED.slice(-2)).toEqual(["por_recolectar_en_tienda", "incidente"]);
  });
