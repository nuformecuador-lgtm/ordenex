...
/**
 * Los cuatro modulos del contrato (T1.1, T3.1, T4.1, T5.1). Los cargadores son
...
describe("R1 · lib/analytics no importa infraestructura", () => {
  it("censa los cuatro modulos del contrato y ninguno mas se cuela sin vigilancia", () => {
...
describe("R1 · lib/analytics se importa sin DATABASE_URL y sin efectos", () => {
  ...
  it("importa los cuatro modulos sin DATABASE_URL y ninguno lanza", async () => {
  ...
  it("importar los cuatro modulos no ejecuta efectos observables", async () => {
    entornoSinBaseDeDatos();
    vi.resetModules();
