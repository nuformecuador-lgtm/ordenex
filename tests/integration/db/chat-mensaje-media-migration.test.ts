...
// Feature 299 — A2/A3.T (R13). La migracion `*_chat_mensaje_media_reacciones`.
//
...
const ESQUEMA = "f299_migracion_test";
...
describe.skipIf(!HAY_BASE_DE_DATOS)(
  "Feature 299 · la migracion aplicada DE VERDAD (R13)",
  () => {
...
describe("Feature 299 · forma de la migracion (A2/A3)", () => {
...
describe("Feature 299 · schema.prisma refleja la migracion (sin drift)", () => {
