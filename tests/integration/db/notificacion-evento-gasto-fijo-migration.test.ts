...
describeSiHayBase("333/A8 — la base aplicada, y el DOWN ejercitado de verdad", () => {
  ...
  // lo demas de este archivo (el UP de la 333, su DOWN con los OCHO/SEIS previos y las
  // afirmaciones sobre los `down.sql` de la 146, la 253, la 262 y la 271) son FOTOS HISTORICAS y
  // NO se tocan. El titulo ya no lleva la cuenta: decia «NUEVE/SIETE» cuando ya eran diez y ocho.
