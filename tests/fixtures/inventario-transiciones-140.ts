...
// recorren el inventario COMPLETO (41 aristas de flujo + 3 de creacion), no un muestreo.
//
...
export interface AristaInventario {
  /** Numero de fila en la tabla A.2 del apendice. */
  n: number;
...
/** A.2 — 41 aristas de flujo (numeracion 1-42 sin el #27). */
...
/** Recuentos fijados por A.3 del apendice: 41 aristas de flujo, 39 pares unicos, 3 de creacion. */
