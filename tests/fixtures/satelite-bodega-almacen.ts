...
export const ALMACEN_SATELITE: FilaAlmacen[] = [
  ...
  filaSatelite("a-04", "z-a", "mensajero_recogiendo_en_bodega", "Escazú", "San Rafael", 4),
  filaSatelite("a-05", "z-a", "mensajero_recogiendo_en_bodega", "San José", null, 5),
  filaSatelite("a-06", "z-a", "por_devolver_a_bodega_central", "Barva", "San Pedro", 6),
  filaSatelite("a-07", "z-a", "por_devolver_a_bodega_central", "Escazú", "San Antonio", 7),
  filaSatelite("a-08", "z-a", "devolviendo_a_bodega_central", "Barva", "San Rafael", 8),
  filaSatelite("a-09", "z-a", "novedad", "Escazú", "San Rafael", 9, true),
  filaSatelite("a-10", "z-a", "novedad", "San José", null, 10),
  filaSatelite("a-11", "z-a", "novedad", "Barva", "San Pedro", 11),
  ...
  filaSatelite("a-14", "z-a", "entregado", "Escazú", "San Rafael", 14, false, false),
  filaSatelite("a-15", "z-a", "entregado", "Escazú", "San Rafael", 15),
  filaSatelite("b-01", "z-b", "en_bodega_satelite", "Escazú", "San Rafael", 20),
  filaSatelite("b-02", "z-b", "novedad", "Cartago", "Occidental", 21),
  filaSatelite("b-03", "z-b", "mensajero_recogiendo_en_bodega", "Cartago", "Occidental", 22),
];
