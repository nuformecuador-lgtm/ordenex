...
const SELECT = {
  ...
  errorTitulo: true,
  errorDetalle: true,
  // Feature 299 (design §4): columnas de los tipos entrantes nuevos. `mediaId` se lee aqui
...
export class ChatMensajeRepository implements IChatMensajeRepository {
      ...
      data: [
        {
          ...
          // Feature 299 (R1/R4/R5/R7/R9): cada grupo lo puebla SOLO su tipo; el resto queda
  ...
  async findMediaParaMensajero(
    ...
    // Feature 299 (design §5.2, R23): UNA sola query. El join mensaje -> conversacion -> orden
