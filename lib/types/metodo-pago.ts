...
// `metodo_pago_value` (patron RolValue/VehiculoValue). OJO: 'SIMPE' en mayusculas
// (F1.4-c), coherente con el enum Prisma. La lista literal permite usar el SEED
...
export const METODO_PAGO_SEED = ["efectivo", "SIMPE", "transferencia"] as const satisfies readonly MetodoPagoValue[];
