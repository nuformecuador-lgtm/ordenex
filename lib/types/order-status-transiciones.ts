...
export const TRANSICIONES = {
  ...
  sin_gestionar: [
    ...
    // FEATURE 273 (T3/T9, R21/R22) — #68. LA NO GESTION EN EL TOPE NO VUELVE A BODEGA: se TERMINA.
    //
    ...
    { to: "rechazada", via: "rechazo_tope_intentos", rol: "admin (aprobar cierre)" }, // #68 (273)
  ],
