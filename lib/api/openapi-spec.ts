    ...
    "/api/ordenes/api-key/cotizacion": {
      post: {
        ...
        description: [
          ...
          "",
          "**Los importes se emiten CRUDOS.** Cada importe viene en una única forma: un string",
          "money-safe de escala 2, sin símbolo de moneda ni separador de miles, con el punto como",
          "separador decimal y exactamente DOS decimales (`1396.46`, `-1578.40`). Es el mismo",
          "formato del `costoEnvio` de `POST /api/ordenes/api-key/carga`, así que todo el canal",
          "habla un solo dialecto de dinero. NO hay un campo formateado en paralelo: el string",
          "crudo ES el contrato. Si necesitas mostrarlo, dale formato en tu lado.",
          "",
          "**CAMBIO INCOMPATIBLE (2026-08-28).** Hasta esa fecha estos importes se servían",
          "formateados (`₡2.500,00`: símbolo, miles con punto y coma decimal). Si tu integración",
          "los parseaba quitando el símbolo y los separadores, quítale ese paso: ahora el valor",
  ...
  components: {
    ...
    schemas: {
      ...
      CotizacionEscenarioEntregado: {
        ...
        properties: {
          flete: { type: "string", description: "Flete de la zona del distrito. String money-safe de escala 2, crudo." },
          iva: { type: "string", description: "IVA del flete. String money-safe de escala 2, crudo." },
          comision: { type: "string", description: "Comisión COD. String money-safe de escala 2, crudo." },
          ivaComision: { type: "string", description: "IVA de la comisión. String money-safe de escala 2, crudo." },
          fulfillment: {
            type: "string",
            description:
              "Monto fijo del servicio de bodega por orden, crudo. Cero si tu tarifa no tiene fulfillment; nunca ausente.",
          },
          total: { type: "string", description: "Lo que recibe la tienda. String money-safe de escala 2, crudo; negativo si el COD no cubre lo facturado." },
        },
      },
      CotizacionEscenarioDevuelto: {
        ...
        properties: {
          ...
          total: { type: "string", description: "Deuda de la tienda. String money-safe de escala 2, crudo y negativo." },
        },
      },
      CotizacionCostos: {
        type: "object",
