 ...
 * previsualización de `/wallet/mensajeros`, y desde la 458-A `OrigenLegibleService` en el
 * servidor, por eso vive en `lib/`— y quien lo lee —`CierresAdminModule`—. Vive en un
