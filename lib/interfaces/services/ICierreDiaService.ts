...
export interface CierreDetalleGestion {
  ...
  // Feature 208/R31: DEPRECADO pero VIVO. Se CONSERVA mientras la presentacion actual lo
  // consuma; su retiro lo decide la 209. `null` cuando la entrega tiene 0 o >=2 metodos.
  metodoPago: MetodoPagoValue | null; // solo entregada (R6)
  /**
   * Feature 208/R31: DESGLOSE del recaudo de la entrega — 0..N lineas `(metodo, monto)`,
   ...
   *
   * Convive con `metodoPago` A PROPOSITO: entre el merge de esta ficha y el de la 209 la
   * pantalla sigue pintando el campo escalar, y el desglose es lo que la 209 consumira para
