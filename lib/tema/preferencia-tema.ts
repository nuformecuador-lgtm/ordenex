...
import { COOKIE_TEMA, COOKIE_TEMA_MAX_AGE, normalizarTema, type Tema } from "./tema";
 ...
 * escribirla sin servidor. No lleva nada sensible: es un enum de tres valores.
 */
...
export function leerPreferenciaTema(): Tema {
