 ...
 * tabs de ordenes. Accion NUEVA e independiente de `listarCatalogoEstatus()`
 * (feature 17): NO relaja la autorizacion de esa (que sigue en maestro/admin);
 * aqui la autz es "todos excepto mensajero" (R2/R4). Sin sesion -> unauthenticated
