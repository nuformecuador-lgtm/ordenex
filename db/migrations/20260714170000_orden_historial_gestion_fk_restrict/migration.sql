-- Feature 64 (F1.4-i, APROBADA por el humano) — defensa en profundidad del enlace
...
-- al conteo el intento de una gestion anulada y resucitaria el bug que la feature 64 mata.
--
