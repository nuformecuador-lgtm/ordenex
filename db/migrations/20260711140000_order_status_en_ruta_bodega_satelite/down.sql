...
-- referencia (patron feature 15/17), para no dejar una FK "orden.estatus_id"
-- colgando de una fila borrada. El valor 'en_ruta_bodega_satelite' del enum
-- Postgres standalone "order_status_value" NO se elimina: Postgres no soporta
