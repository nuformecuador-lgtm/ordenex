...
### Especificación
- [x] `specs/230-.../requirements.md` con R1…R52 en EARS, más D1…D13 cerradas por el humano.
- [x] `specs/230-.../design.md` con **nueve** alternativas descartadas y su porqué (§9.1-§9.9).
- [~] `specs/230-.../tasks.md`: **24 de 25 tasks en `[x]`. T8.1 (el gate) sigue `[ ]`.** Es la
