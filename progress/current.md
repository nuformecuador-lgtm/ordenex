...
|--------|------|------|--------|
| feature/63-orden-lista-actualizada | fullstack | F2.1 (impl) | `in_progress`: F1.4 aprobada (a–g + h=adminSatelite fuera v1; exclude=front). backend_dev (A+B, R1–R11) → frontend_dev (C, R12–R20) → reviewer. Rama de `adjustments` (`0337c4d`) |
