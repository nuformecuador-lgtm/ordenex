...
|--------|------|------|--------|
| feature/63-orden-lista-actualizada | fullstack | F2.3 (pre-PR) | **impl COMPLETA (R1–R20) + reviewer APROBADO 0 bloqueantes** (el rechazo inicial fue por drift de columnas fuera de alcance de la 62, REVERTIDO a base `0337c4d`). 42 tests propios verde; 3 regresados restaurados (14/14). CERO rojos nuevos vs baseline. **PENDIENTE: destino del PR + merge (OK humano).** |
