...
| R11 | `tests/unit/guards/caja-composicion-exhaustiva.guardia.test.ts` › R11 (ficha 343): los cuatro conceptos + los dos nombrados + «otros» suman `egresosPropios` | ✅ |
...
| R13 | `caja-composicion-exhaustiva.guardia.test.ts` › R13: cada categoria propia aporta a UNA sola cubeta, nunca a dos + › R13 (ficha 343): los dos egresos NOMBRADOS salieron del complemento de verdad | ✅ |
...
Backend de la 343 completo (B0–B4): «Otros» ya solo puede contener `egreso_gasto`, el detalle de
