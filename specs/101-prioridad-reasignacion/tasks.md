...
- [ ] **T1. Migración aditiva `orden.prioridad`.**
...
- [ ] **T2. `[P]` Encender prioridad en la liberación SLA (feature 99).**
...
- [ ] **T3. `[P]` Apagar prioridad al reasignar desde bodega.**
...
- [ ] **T4. `[P]` Aserción negativa de no-encendido (R3).**
...
- [ ] **T5. Exponer `prioridad` en el listado de órdenes.**
...
- [ ] **T6. Exponer `prioridad` en el listado satélite.**
...
- [ ] **T8. Sort satélite.** (depende de T6)
...
- [ ] **T9. `[P]` Prop `rowClassName` en `DataTable`.**
...
- [ ] **T10. Resalte en `/ordenes`.** (depende de T9, T5)
...
- [ ] **T11. Resalte en `/recepcion-satelite`.** (depende de T9, T6)
...
- [ ] **T13. Trazabilidad y verificación final.**
