...
- [x] **T1 [P]** — Tipos y schemas del manifiesto.
...
- [x] **T2 [P]** — Contrato del servicio único.
...
- [x] **T3 [P]** — Contrato de repositorio (aditivo).
...
- [x] **T4** — Implementación de repositorio. *(dep: T3)*
...
- [x] **T5 ⚠** — Servicio único `ManifiestoService`. *(dep: T1, T2, T3; §9.2–§9.5, §9.8)*
...
- [x] **T6** — Server Action de lectura. *(dep: T5)*
...
- [x] **T7** — `buildXlsxRows` + `XLSX_MIME` en el generador existente. *(sin deps)*
...
- [x] **T8 [P]** — Módulo puro del manifiesto. *(dep: T1, T7)*
...
- [x] **T9 ⚠ [P]** — Helper de descarga + botón compartido. *(dep: T1, T6, T8; §9.7)*
...
- [x] **T11 [P]** — Generar guía + asignar desde bodega. Archivos:
...
- [x] **T12 [P]** — Ruteo a satélite (maestro) y asignación satélite. Archivos:
...
- [x] **T13 [P]** — Envío de devolución a central. Archivos:
...
- [x] **T14 ⚠ [P]** — Envío a la tienda. Archivos:
...
- [x] **T15 [P]** — Unit del servicio único. Archivo:
...
- [x] **T16 [P]** — Unit del repositorio. Archivo:
...
- [x] **T17 [P]** — Unit del generador XLSX. Archivo:
...
- [x] **T18 [P]** — Integración de la Server Action. Archivo:
...
- [x] **T19 [P]** — Componentes: botón compartido. Archivo:
...
- [x] **T20 [P]** — Componentes: los 5 flujos. Archivos:
...
- [x] **T21** — Regresión del generador compartido. *(dep: T7)*
...
- [x] **T22** — Verificación ejecutable. *(dep: todas)*
