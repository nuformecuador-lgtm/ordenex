...
- [x] **T0 — Migracion aditiva** (R14/R19/R22)
...
- [x] **T1 — Schema Prisma** (depende de T0) (R22)
...
- [x] **T2 [P] — Interfaz + repo del resolver** (R1/R2/R3)
...
- [x] **T3 [P] — Util puro resultado->monto** (R5/R6/R7/R7b/R8/R9)
...
- [x] **T4 [P] — Resolver vehiculo del mensajero** (R1/R4)
...
- [x] **T5 — DTOs 37** (depende de T1) (R10/R11/R16 base)
...
- [x] **T6 — listarCierreDia deriva pago** (depende de T2/T3/T4/T5) (R10/R11/R21)
...
- [x] **T7 — solicitarCierre snapshotea** (depende de T6) (R12/R13/R14/R15)
...
- [x] **T8 — Detalle admin expone snapshot** (depende de T5/T7) (R16/R17)
...
- [x] **T9 — Consolidacion + snapshot agregado** (depende de T1/T7) (R18/R19)
...
- [x] **T10 — Detalle bodega-admin** (depende de T9) (R20)
...
- [x] **T11 [P] — Columna/total en vistas** (R10/R11/R16/R17/R18/R20)
...
- [x] **T14 — Suite completa + build** (regla #5)
