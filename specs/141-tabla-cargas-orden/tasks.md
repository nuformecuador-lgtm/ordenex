...
- [ ] **T15. Migración en sitio: columna `name` + índice único compuesto** (R8, R9, R10, R13)
...
- [ ] **T16. Prisma: `name` + `@@unique([usuarioCarga, name])`** (R8, R9) — depende de T15
...
- [ ] **T17. [P] Ampliar el test estático de la migración** (R8, R9, R10, R13) — depende de T15
...
- [ ] **T18. Rehacer `ensureCargaEnTx`: crear vs reutilizar** (R15–R17, R19, R21–R24, R34)
  — depende de T16
...
- [ ] **T19. Servicio: `name` y sin id propuesto por el cliente** (R16, R17, R20–R23, R26,
...
- [ ] **T20. Borde HTTP: `name` en ambas vías + 409/403/422** (R18–R20, R24, R38, R39, R41)
  — depende de T19
...
- [ ] **T21. Cliente de chunks: dejar de generar el UUID** (R15–R17, R26, R29) — depende de T20
...
- [ ] **T22. [P] Test del invariante "el id nunca lo elige el cliente"** (R15, R19)
  — depende de T18
...
- [ ] **T23. [P] Cerrar el bloque 5** (R15–R25) — depende de T15–T22
...
- [ ] **T24. `download_type` en el borde de la carga por API** (R42–R46, R55) — depende de T20
...
- [ ] **T25. Modo individual en `EtiquetasLotePdfService`** (R48, R49, R52) — depende de T24
...
- [ ] **T26. Persistencia de las URLs en el repositorio** (R47, R48) — depende de T25
...
- [ ] **T27. `EtiquetasDescargaService` (orquestación por modo)** (R47–R51, R53, R54)
  — depende de T26
...
- [ ] **T28. Cableado en el endpoint + contrato de respuesta** (R47–R55) — depende de T27
...
- [ ] **T29. [P] Ajustar la no-regresión de `download_url`** (R40, R47, R48) — depende de T28
...
- [ ] **T30. Rehacer el mapa de trazabilidad R1–R55** — depende de T15–T29
