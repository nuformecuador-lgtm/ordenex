...
- [ ] **T0. Migración `20260727120000_carga_orden_carga_id`** (R1–R11)
...
- [ ] **T1. Schema Prisma** (R1–R7, R11) — depende de T0
...
- [ ] **T2. [P] Test estático de la migración** (R1–R11) — depende de T0
...
- [ ] **T3. [P] Actualizar la denylist de `zonas-migration.test.ts`** — depende de T0
...
- [ ] **T4. Helper transaccional `ensureCargaEnTx`** (R12, R13, R17, R23, R24) — depende de T1
...
- [ ] **T5. `LoteContexto` en `IOrdenRepository`** (R12, R19, R25) — depende de T4
...
- [ ] **T6. `OrdenRepository`: ensure + `carga_id` en la misma tx** (R23, R24, R25) — depende de T5
...
- [ ] **T7. `BulkOrdenService.cargarMasiva` propaga el lote** (R12–R15, R18, R27) — depende de T6
...
- [ ] **T8. [P] `BulkOrdenService.cargarViaApi` crea su lote** (R19–R22, R28) — depende de T6
...
- [ ] **T9. Controller `carga-masiva/chunk`** (R16, R17, R27, R30) — depende de T7
...
- [ ] **T10. [P] Controller `api-key/carga`** (R28, R30) — depende de T8
...
- [ ] **T11. Cliente de chunks propaga el lote (fontanería, SIN UI)** (R12, R13, R14, R18)
  — depende de T9
...
- [ ] **T12. [P] Test del invariante "sin lotes huérfanos ni órdenes a medias"** (R23, R24)
...
- [ ] **T13. [P] Test de no-regresión del alta manual y del histórico** (R8, R26, R29, R11)
...
- [ ] **T14. Mapa de trazabilidad R→test** — depende de T2–T13
