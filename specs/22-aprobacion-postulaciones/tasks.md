...
- [ ] **T1 [P]** Crear `lib/config/aprobacion-postulaciones.ts` con
...
- [ ] **T2 [P]** Crear `lib/types/aprobacion-postulacion.ts`: `PostulacionPendienteDTO`,
...
- [ ] **T3 [P]** Crear `lib/interfaces/services/IAprobacionPostulacionService.ts`
...
- [ ] **T4 [P]** Crear `lib/interfaces/repositories/IAprobacionPostulacionRepository.ts`
...
- [ ] **T5 [P]** Crear `lib/interfaces/external/ISignedUrlProvider.ts`
  (`createSignedUrl`, `createSignedUrls`). Satisface: R8, R9. Hecho: compila.

## Bloque 1 — Implementaciones (dependen del Bloque 0)

- [ ] **T6** (dep T5) Implementar `lib/storage/SupabaseSignedUrlProvider.ts` sobre
...
- [ ] **T7** (dep T4) Implementar `lib/repositories/AprobacionPostulacionRepository.ts`
...
- [ ] **T8** (dep T3, T4, T5, T1) Implementar
...
- [ ] **T9** (dep T8, T2) Implementar `lib/actions/aprobacion-postulaciones.ts`
...
- [ ] **T10 [P]** (dep T8) Unit de service en
...
- [ ] **T11 [P]** (dep T9) Integration de action en
...
- [ ] **T12 [P]** (dep T6) Unit de `SupabaseSignedUrlProvider`
...
- [ ] **T13 [P]** (dep T7) Unit de repository
...
- [ ] **T14** (dep T10–T13) Escribir `progress/impl_22-aprobacion-postulaciones.md`
...
- [ ] **T15** (dep T14) Verificación final: `pnpm run typecheck`, `pnpm run lint`,
