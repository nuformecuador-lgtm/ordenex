...
### [ ] T1 `[P]` — Comprobar que H1 sigue siendo cierto
...
### [ ] T2 `[P]` — La red que hoy afirma el «?» como enlace
...
### [ ] T3 — El puerto `IAsistenteProvider`
...
### [ ] T6 — `lib/asistente/contexto.ts` y `lib/asistente/instrucciones.ts`
...
### [ ] T7 — 🚪 de diseño: `/design` para el panel
...
### [ ] T9 — `AsistenteUsoRepository` + su interfaz
...
### [ ] T10 — `AsistenteService` + su interfaz
...
### [ ] T11 — `app/api/asistente/route.ts`
...
### [ ] T12 `[P]` — El control de la guardia de API
...
### [ ] T14 — `providers/AsistenteProvider.tsx`
...
### [ ] T15 — `components/shared/AsistentePanel.tsx`
...
### [ ] T18 `[P]` — `asistente-sin-datos.guardia.test.ts`
...
### [ ] T19 `[P]` — `asistente-sin-persistencia.guardia.test.ts`
...
### [ ] T20 `[P]` — `asistente-sin-frontmatter.guardia.test.ts`
...
### [ ] T21 — Ampliar `ayuda-md-viajan-a-produccion.guardia.test.ts`
...
### [ ] T22 — Las cinco mutaciones obligatorias
