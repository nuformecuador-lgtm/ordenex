...
- [ ] **T0.1 — Sustituir las dos afirmaciones agregadas por la lista declarada.**
...
- [ ] **T0.2 — Añadir la mitad negativa del censo.** [P con T0.1]
...
- [ ] **A.1 — Extraer el criterio y añadir el conjunto completo (repositorio).** · depende de T0
...
- [ ] **A.2 — Vigencia de identificadores (repositorio).** · depende de A.1
...
- [ ] **A.3 — Servicio, schemas y bordes de la satélite.** · depende de A.1, A.2
...
- [ ] **A.4 — La pantalla descarga por su acción y deja de filtrar en el navegador.**
  · depende de A.3
...
- [ ] **A.5 — La poda en la pantalla.** · depende de A.3, A.4
...
- [ ] **A.6 — Censo y cierre de la tanda A.** · depende de A.4
...
- [ ] **B.1 — Servicios, schemas y bordes.** · depende de T0
...
- [ ] **B.2 — Las dos pantallas.** · depende de B.1
...
- [ ] **B.3 — Censo y cierre.** · depende de B.2 — listados 6 y 7 fuera de `PENDIENTES_184`
...
- [ ] **C.1 — Servicio, schema y borde.** · depende de T0
...
- [ ] **C.2 — La pantalla.** · depende de C.1
...
- [ ] **C.3 — Censo y cierre.** · depende de C.2 — listado 1 fuera (8 restantes).

---

## Tanda D — Cierres del día del admin (listados 2 y 3) `[P con E, F]`

- [ ] **D.1 — Repositorio.** · depende de T0
...
- [ ] **D.4 — Censo y cierre.** · depende de D.3 — listados 2 y 3 fuera (6 restantes).

---

## Tanda E — Cierres de bodega del admin (listados 4 y 5) `[P con D, F]`

- [ ] **E.1 — Repositorio.** · depende de T0
...
- [ ] **E.2 — Servicios, schemas, bordes.** · depende de E.1 — **Hecho:** como D.2.

- [ ] **E.3 — Las dos pantallas.** · depende de E.2
...
- [ ] **E.4 — Censo y cierre.** · depende de E.3 — listados 4 y 5 fuera (4 restantes).

---

## Tanda F — Incidentes (listados 8 y 9) `[P con D, E]`

- [ ] **F.1 — Repositorio.** · depende de T0
...
- [ ] **F.2 — Servicios, schemas, bordes.** · depende de F.1 — **Hecho:** como D.2.

- [ ] **F.3 — Las dos pantallas.** · depende de F.2
...
- [ ] **F.4 — Censo y cierre.** · depende de F.3 — listados 8 y 9 fuera (2 restantes).
...
- [ ] **G.1 — Servicios, schemas y bordes.** · depende de T0
...
- [ ] **G.2 — Las dos pantallas + el segundo censo.** · depende de G.1
...
- [ ] **G.3 — Censo y cierre.** · depende de G.2 — `PENDIENTES_184` queda **vacío**.

---

## Tanda H — Cierre de la deuda: guardia, retirada y bitácora

- [ ] **H.1 — Guardia nueva.** · depende de A–G
...
- [ ] **H.2 — Retirar el adaptador muerto.** · depende de H.1
...
- [ ] **H.3 — Bitácora y trazabilidad final.** · depende de H.2
