...
- [x] **T1 [P]. Crear `components/shared/Logo.tsx`** (R6).
...
- [x] **T2 [P]. Test `tests/components/Logo.test.tsx`** (R6).
...
- [x] **T4. Test `tests/components/LandingPage.test.tsx`** (R2, R3, R4, R5).
...
- [x] **T5. Mover `app/(app)/page.tsx` → `app/(app)/dashboard/page.tsx`** (R9, R11).
...
- [x] **T6. Reapuntar los tests del dashboard** (R9).
...
- [x] **T7. Editar `middleware.ts`** (R1, R7, R8, R10, R16).
...
- [x] **T8. Ampliar `tests/unit/auth/middleware.test.ts`** (R1, R7, R8, R10, R16).
...
- [x] **T9 [P]. `app/login/page.tsx`: `redirect("/")` → `redirect("/dashboard")`** (R12).
  **Hecho cuando:** cambio aplicado.

- [x] **T10 [P]. `app/recuperar-contrasena/page.tsx`: `redirect("/")` →
  `redirect("/dashboard")`** (R13).
  **Hecho cuando:** cambio aplicado.

- [x] **T11 [P]. `LoginForm.tsx` `getRedirectTarget`: ambos `return "/"` →
...
- [x] **T12. Actualizar tests de redirect de páginas** (R12, R13).
...
- [x] **T13. Test de `getRedirectTarget`** (R14, R15).
...
- [x] **T14. Barrido de referencias residuales a `/` como home.**
...
- [x] **T15. `./init.sh` + `pnpm test` en verde** (regla 5).
