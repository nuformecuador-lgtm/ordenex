...
- [ ] **T0.1 — Confirmar en el ARCHIVO REAL los doce símbolos sobre los que se construye.** [P]
...
- [ ] **T1.1 — `lib/types/cohorte-carga.ts`.**
...
- [ ] **T1.2 — `lib/interfaces/repositories/ICohorteCargaRepository.ts`.** [P] · depende de T1.1
...
- [ ] **T1.3 — El octavo prefijo de caché.** · depende de T0.3
...
- [ ] **T2.1 — Exportar `DIA_CR` desde `ConteoCargadasPorDiaRepository`.**
...
- [ ] **T2.2 — `lib/repositories/CohorteCargaRepository.ts`.** · depende de T2.1
...
- [ ] **T2.3 — `tests/unit/analytics/cohorte-carga-sql.test.ts`: el `where`, sin base.** [P] · depende de T2.2
...
- [ ] **T2.4 — `tests/unit/analytics/cohorte-terminales.guardia.test.ts`.** [P] · depende de T2.2
...
- [ ] **T3.1 — `lib/services/CohorteCargaService.ts`.**
...
- [ ] **T3.2 — `lib/actions/cohorte-carga.ts` (`'use server'`).** · depende de T3.1
...
- [ ] **T3.3 — El botón «Actualizar» tira también esta lectura.** [P] · depende de T1.3
...
- [ ] **T4.1 — `cohorte-carga-fechas.int.test.ts`: la trampa horaria.**
...
- [ ] **T4.2 — `cohorte-carga-desenlaces.int.test.ts`: los cuatro cubos.** [P] · depende de T4.1
...
- [ ] **T4.3 — `cohorte-carga-ultima-terminal.int.test.ts`.** [P] · depende de T4.1
...
- [ ] **T4.4 — `cohorte-carga-ventana.int.test.ts`: LA INVERSIÓN (§0).** · depende de T4.1
...
- [ ] **T4.5 — `cohorte-carga-reloj.int.test.ts`.** [P] · depende de T4.1
...
- [ ] **T4.6 — `cohorte-carga-alcance.int.test.ts`: la frontera, en SQL.** [P] · depende de T4.1
...
- [ ] **T4.7 — `cohorte-carga-equivalencia.int.test.ts`: no divergir de la serie hermana.**
  · depende de T4.2
...
- [ ] **T5.1 — `tests/unit/analytics/cohorte-carga-servicio.test.ts`.** [P]
...
- [ ] **T5.2 — `tests/unit/analytics/cohorte-carga-action.test.ts`.** [P]
...
- [ ] **T5.3 — `tests/unit/analytics/cohorte-consulta-unica.test.ts`.** [P]
...
- [ ] **T6.1 — `tests/integration/db/cohorte-carga-indices.int.test.ts`.**
...
- [ ] **T6.2 — Decidir con la medición, no con la intuición.** · depende de T6.1 y T0.2
...
- [ ] **T7.1 — `app/(app)/analitica/_components/entregas/CohorteCargaTabla.tsx`.**
...
- [ ] **T7.2 — Montarla en `app/(app)/analitica/page.tsx`.** · depende de T7.1
...
- [ ] **T7.3 — `CohorteCargaTabla.test.tsx`.** [P] · depende de T7.1
...
- [ ] **T7.4 — `tests/unit/analytics/cohorte-frontera.guardia.test.ts`.** [P] · depende de T7.1
...
- [ ] **T8.1 — Trazabilidad completa.** Rellenar el mapa de abajo en `progress/impl_411.md` con el
...
- [ ] **T8.3 — Gate COMPLETO.** · depende de T8.1
