...
> features fullstack en vuelo (278/288) — ver `status_note` de la 299. Y hay que aprobar el spec
...
- [ ] **H1.** Recorrido manual con un payload real de Meta (imagen + nota de voz + reacción +
  ...
  *Hecho:* nota en `progress/impl_299.md` con lo observado (sin pegar PII).
...
- [ ] **H3.** `progress/impl_299.md` con el mapa R→test completo y `feature_list.json` id 299 a
  `done`. Depende de H2.
