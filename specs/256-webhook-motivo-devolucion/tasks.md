...
### [x] T0. Baseline medido, no supuesto
...
### [x] T1. `DatosEntregaOrden` gana `causaDevolucion` (dep: T0)
...
### [x] T2. `WebhookOrdenReader` proyecta la causa (dep: T1)
...
### [x] T3. El service publica `data.motivo` (dep: T2)
...
### [x] T4. Test de repositorio: qué gestión manda (dep: T2) — **R8, R9, R10, R11, R12**
...
### [x] T5. [P] Test de service: el campo, sus valores y su forma (dep: T3) — **R1, R2, R3, R6, R7, R19, R22**
...
### [x] T6. Los dos caminos del `null` (dep: T5) — **R4, R5**
...
### [x] T7. Idempotencia (dep: T5) — **R13, R14, R16**
...
### [x] T8. La ventana declarada (dep: T7) — **R15**
...
### [x] T9. [P] No-regresión del contrato (dep: T3) — **R17, R18, R20, R21, R23**
...
### [x] T10. Publicar el evento en el OpenAPI (dep: T3) — **R24**
...
### [~] T11. Trazabilidad y gate (dep: T4–T10) — trazabilidad HECHA; el gate lo corre el leader
